...
<li class="card">
    ...
    <div class="card-content">
        <div class="card-sub-content">
            ...
            <div class="line-container"><span class="line-icon"><i class="logo fab fa-github-square"></i></span><span class="line-content"><a href="http://${ this.github }" target="_blank">${ this.github }</a></span></div>
        </div>
    </div>
</li>`
        }
